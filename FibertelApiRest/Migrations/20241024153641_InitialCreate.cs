        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idCategoria = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    categoriaNombre = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    imagen = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    estado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    direccionFiscal = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idMarca = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    marcaNombre = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    imagen = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    estado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    finOperacion = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idRecojo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fechaListo = table.Column<DateTime>(type: "datetime2", nullable: true),
                    fechaEntrega = table.Column<DateTime>(type: "datetime2", nullable: true),
                    responsableEntrega = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    precioOferta = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    cantidad = table.Column<int>(type: "int", nullable: false),
                    detalle = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
                    estado = table.Column<bool>(type: "bit", nullable: false),
                    imagen01 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    imagen02 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    imagen03 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    imagen04 = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    idCategoria = table.Column<int>(type: "int", nullable: false),
                    idMarca = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nDomicilio = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    codigoPostal = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    fechaEnvio = table.Column<DateTime>(type: "datetime2", nullable: true),
                    fechaEntrega = table.Column<DateTime>(type: "datetime2", nullable: true),
                    responsableEntrega = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idCliente = table.Column<int>(type: "int", nullable: false),
                    idPersonal = table.Column<int>(type: "int", nullable: true),
                    idEnvio = table.Column<int>(type: "int", nullable: true),
                    idRecojo = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idDetallePedido = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    cantidad = table.Column<int>(type: "int", nullable: false),
                    precioUnitario = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    precioDescuento = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Merino Zalasar", "982332873", null, new DateTime(2024, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Andy", "23123465", "Responsable de Envio" },
                    { 2, "Merino Zalasar", "982332873", new DateTime(2024, 11, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Andy", "23123465", "Responsable de Envio" }
                });
